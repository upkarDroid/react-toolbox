    ...
    _createClass(Input, [{
      ...
      value: function render() {
        ...
        var _props = this.props,
            ...
            others = _objectWithoutProperties(_props, ['children', 'disabled', 'error', 'floating', 'hint', 'icon', 'name', 'label', 'maxLength', 'multiline', 'required', 'theme', 'type', 'value', 'onKeyPress', 'rows', 'defaultValue']);
        ...
        var valuePresent = value !== null && value !== undefined && value !== '' && !((typeof value === 'undefined' ? 'undefined' : _typeof(value)) === Number && isNaN(value)) || this.refs.input && this.refs.input.value !== '' || defaultValue && defaultValue !== '';
