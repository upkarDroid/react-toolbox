...
var _reactTransformHmr2 = (0, _reactTransformHmr4.default)({
  filename: 'components/input/Input.js',
  ...
  var Input = _wrapComponent('Input')((_temp2 = _class = function (_React$Component) {
    ...
    _createClass(Input, [{
      ...
      value: function render() {
        ...
        var valuePresent = value !== null && value !== undefined && value !== '' && !((typeof value === 'undefined' ? 'undefined' : _typeof(value)) === Number && isNaN(value)) || this.refs.input && this.refs.input.value !== '';
    ...
    icon: _react3.default.PropTypes.oneOfType([_react3.default.PropTypes.string, _react3.default.PropTypes.element]),
    ...
    rows: _react3.default.PropTypes.number,
    theme: _react3.default.PropTypes.shape({
      bar: _react3.default.PropTypes.string,
      counter: _react3.default.PropTypes.string,
      disabled: _react3.default.PropTypes.string,
      error: _react3.default.PropTypes.string,
      errored: _react3.default.PropTypes.string,
      hidden: _react3.default.PropTypes.string,
      hint: _react3.default.PropTypes.string,
      icon: _react3.default.PropTypes.string,
      input: _react3.default.PropTypes.string,
      inputElement: _react3.default.PropTypes.string,
      required: _react3.default.PropTypes.string,
      withIcon: _react3.default.PropTypes.string
    }),
