  ...
  var IconButton = _wrapComponent('IconButton')((_temp2 = _class = function (_Component) {
    ...
    _createClass(IconButton, [{
      ...
      value: function render() {
        ...
        return _react3.default.createElement(element, props, icon ? typeof icon === 'string' ? _react3.default.createElement(FontIcon, { className: theme.icon, value: icon }) : icon : null, children);
      }
    }]);
