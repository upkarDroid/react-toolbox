...
var _reactTransformHmr2 = (0, _reactTransformHmr4.default)({
  filename: 'components/ripple/Ripple.js',
    ...
    var RippledComponent = _wrapComponent('RippledComponent')((_temp2 = _class = function (_Component) {
      ...
      function RippledComponent() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = RippledComponent.__proto__ || Object.getPrototypeOf(RippledComponent)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
          ...
          if (!_this.props.disable && event.touches) {
            _this.setTouchStartCoordinates(event);
            _this.startTime = Date.now();
          }
        }, _this.setTouchStartCoordinates = function (event) {
          _this.firstTouchY = event.touches[0].clientY;
          _this.firstTouchX = event.touches[0].clientX;
          ...
          var deltaY = Math.abs(y - _this.firstTouchY);
          var deltaX = Math.abs(x - _this.firstTouchX);
      ...
      _createClass(RippledComponent, [{
        ...
        value: function addRippleRemoveEventListener(rippleKey) {
          ...
          _events2.default.addEventListenerOnTransitionEnded(this.refs[rippleKey], function onOpacityEnd(e) {
            if (e.propertyName === 'opacity') {
              ...
              self.setState({
                ripples: _utils2.default.removeObjectKey(rippleKey, self.state.ripples)
              });
            }
          });
        }
        ...
        value: function animateRipple(x, y, isTouch) {
          ...
          if (this.rippleShouldTrigger(isTouch)) {
            (function () {
              ...
              _this2.setState((0, _immutabilityHelper2.default)(_this2.state, { ripples: _defineProperty({}, key, { $set: initialState }) }), function () {
                _this2.refs[key].offsetWidth; //eslint-disable-line no-unused-expressions
                _this2.setState((0, _immutabilityHelper2.default)(_this2.state, { ripples: _defineProperty({}, key, { $merge: runningState }) }));
              });
            })();
          }
        }
        ...
        value: function render() {
          ...
          if (!ripple) return _react3.default.createElement(ComposedComponent, _extends({ children: children }, other));
          return _react3.default.createElement(
            ComposedComponent,
            _extends({}, other, { onMouseDown: this.handleMouseDown, onTouchStart: this.handleTouchStart, onTouchEnd: this.handleTouchEnd }),
            children,
            Object.keys(ripples).map(function (key) {
              return _this3.renderRipple(key, rippleClassName, ripples[key]);
            })
          );
        }
      }]);
